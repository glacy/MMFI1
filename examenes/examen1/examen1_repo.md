---
title: Examen  1 (Extraordinario) 
description: Examen  1 (Extraordinario)
short_title: Examen  1 (Extraordinario)
author: " "
tags: [analisis_vectorial, variable-compleja, teorema-stokes, identidades-vectoriales, residuos, integrales-complejas, examen-parcial-reposicion]
subject: IF3602 - II semestre 2025 
keywords: [cálculo, análisis, vectorial, variable, compleja]
date: "2025-10-16"
downloads:
   - file: ./examen1_repo.md
     title: examen1_repo.md
   - file: ./examen1_repo.pdf
     title: examen1_repo.pdf
#    - file: ./solucion_ex1_e1_repo.md
#      title: solucion_ex1_e1_repo.md
#    - file: ./solucion_ex2_e1_repo.md
#      title: solucion_ex2_e1_repo.md
#    - file: ./solucion_ex3_e1_repo.md
#      title: solucion_ex3_e1_repo.md
---
...
```{include} ./ex1_e1_repo.md

```

````

<!-- ````{solution} ex1-e1-repo
:label: solution-ex1-e1-repo
:class: dropdown


```{include} ./solucion_ex1_e1_repo.md
...
```{include} ./ex2_e1_repo.md

```

````

<!-- ````{solution} ex2-e1-repo
:label: solution-ex2-e1-repo
:class: dropdown


```{include} ./solucion_ex2_e1_repo.md
...
```{include} ./ex3_e1_repo.md

```
````

<!-- ````{solution} ex3-e1-repo
:label: solution-ex3-e1-repo
:class: dropdown


```{include} ./solucion_ex3_e1_repo.md
...
```{include} ./ex4_e1_repo.md

```

````

<!-- ````{solution} ex4-e1-repo
:label: solution-ex4-e1-repo
:class: dropdown


```{include} ./solucion_ex4_e1_repo.md
